...
UPDATE configuration SET configuration_title='Äê³ÛÁ÷ÎÁ', configuration_description='Äê³ÛÁ÷ÎÁ¤Ë¤è¤ëÇÛÁ÷¤òÄó¶¡¤¹¤ë¤«¤É¤¦¤«¤òÀßÄê¤·¤Þ¤¹¡£' WHERE configuration_key='MODULE_SHIPPING_FLAT_STATUS';
...
UPDATE configuration SET configuration_title='ÀÇ¼ïÊÌ', configuration_description='Äê³ÛÁ÷ÎÁ¤ËÅ¬ÍÑ¤µ¤ì¤ëÀÇ¼ïÊÌ¤òÁªÂò¤·¤Þ¤¹¡£' WHERE configuration_key='MODULE_SHIPPING_FLAT_TAX_CLASS';
